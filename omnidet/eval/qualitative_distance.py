...
from models.md2_decoder import DepthDecoder
from models.normnet_decoder import NormDecoder
from models.resnet import ResnetEncoder
from utils import Tupperware
from qualitative_semantic import pre_image_op
...
def collect_args() -> argparse.Namespace:
    ...
    parser.add_argument('--config', help="Config file", type=str, default="/home/seok436/WoodScape/omnidet/data/params.yaml")
...
def test_simple(args):
    ...
    # Depth Original Decoder
    # decoder = DepthDecoder(encoder.num_ch_enc).to(args.device)
    # Norm decoder
